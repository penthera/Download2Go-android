...
public class MainActivity extends AppCompatActivity {
    ...
    private static String BACKPLANE_PUBLIC_KEY = "73ca8dfb4e0f7144fdf43640aa70cc0fdfc9d10e4cd530d5ba6370cf56527f39";
    private static String BACKPLANE_PRIVATE_KEY = "a546f1037420a552f5d6305cb85feb1d1d710555a48e6afc2d74237ccf335938";
    ...
    //
    AppCompatSpinner logLevelSpinner;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        logLevelSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                int sdkLogLevel;
                switch (position) { // Our string resources array is arranged from debug to assert
                    case 0:
                        sdkLogLevel = Common.LogLevels.LOG_LEVEL_DEBUG;
                        break;
                    case 1:
                        sdkLogLevel = Common.LogLevels.LOG_LEVEL_INFO;
                        break;
                    case 2:
                        sdkLogLevel = Common.LogLevels.LOG_LEVEL_ERRORS;
                        break;
                    case 3:
                        sdkLogLevel = Common.LogLevels.LOG_LEVEL_CRITICAL;
                        break;
                    case 4:
                        sdkLogLevel = Common.LogLevels.LOG_LEVEL_OFF;
                        break;
                    default:
                        return; // Do not change the level
                }
                // This method
                Common.LogLevelHelper.updateLogLevel(sdkLogLevel, MainActivity.this);
            }
    ...
    public void initVirtuosoSDK(Bundle savedInstanceState) {
        ...
        // set initial logging level in SDK and in UI (defaults to DEBUG in the debug SDK on initial start)
        Common.LogLevelHelper.updateLogLevel(Common.LogLevels.LOG_LEVEL_DEBUG, this);
