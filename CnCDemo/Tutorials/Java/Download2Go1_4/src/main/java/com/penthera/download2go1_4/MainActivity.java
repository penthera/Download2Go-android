...
public class MainActivity extends AppCompatActivity {
    ...
    private ImageView ancillaryImage;
    ...
    // Display a menu to enable switching to a second activity containing status information
    @Override
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.status_view: {
                Intent i = new Intent(this, StatusViewActivity.class);
                startActivity(i);
                }
                return true;
    ...
    private void downloadAsset() {
        ...
        try {
            ...
            ancillaryUrl = new URL(ANCILLARY_IMAGE_URL);
        } catch (MalformedURLException mue) {
        ...
        String[] tags = new String[]{ANCILLARY_IMAGE_TAG};

        // Set up the list of ancillary files to download with the asset
        List<AncillaryFile> fileList = new ArrayList<>();
        fileList.add(new AncillaryFile(ancillaryUrl, "Movie Image", tags));
        ...
        MPDAssetBuilder.MPDAssetParams params = new MPDAssetBuilder()
                ...
                .withAncillaryFiles(fileList)    // add the file list to the builder
                .build();
            ...
            if (forceUpdate || progress != lastProgress) {
                ...
                switch (downloadStatus) {
                    ...
                    case Common.AssetStatus.DOWNLOAD_COMPLETE:
                        ...
                        // Show ancillary image once download complete
                        mainActivity.showAncillaryImage(asset);
                        break;
