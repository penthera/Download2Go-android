...
public class NotificationFactory {
    ...
    private static final String channelID = "DOWNLOAD2GO_1_1_CHANNEL_ID";
    private static final String channelName = "Download2Go1.1 Background Activity";
     ...
     * may be created and destroyed on multiple occasions by the OS */
