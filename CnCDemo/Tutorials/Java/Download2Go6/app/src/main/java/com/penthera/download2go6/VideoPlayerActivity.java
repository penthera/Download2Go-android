 ...
 * This player also supports playing back content with client side ad insertion.
 * The advertising definitions document is provided by the SDK when it determines that
 * the asset supports client side adverts.
 */
public class VideoPlayerActivity extends AppCompatActivity implements PlaybackPreparer {
    ...
    // Required for advert playback - SDK component for fetching the advertising definitions generated by the SDK
    ...
    private void initializePlayer() {
        if (player == null) {
            ...
            // This code loads the advertising
