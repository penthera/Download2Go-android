...
public class NotificationFactory {
    ...
    private static final String channelID = "DOWNLOAD2GO_7_CHANNEL_ID";
    private static final String channelName = "Download2Go7 Background Activity";
            ...
            switch(intentAction) {
                case Common.Notifications.INTENT_NOTIFICATION_DOWNLOAD_COMPLETE:
                    ...
                    if (asset != null) {
                        Log.d(TAG, "DOWNLOAD COMPLETE NOTIFICATION FOR " + asset.getUuid() + " stat: " + (hasInfo ? info : "unknown"));
                            ...
                            Log.d(TAG, "DOWNLOAD COMPLETE NOTIFICATION FOR UNKNOWN" + " stat: " + (hasInfo ? info : "unknown"));
                    }
                    break;
                ...
                case Common.Notifications.INTENT_NOTIFICATION_DOWNLOAD_START:
                    ...
                    if (asset != null) {
                        ...
                        Log.d(TAG, "DOWNLOAD START NOTIFICATION FOR UNKNOWN" + " stat: " + (hasInfo ? info : "unknown"));
                    }
                    break;
                ...
                case Common.Notifications.INTENT_NOTIFICATION_DOWNLOAD_UPDATE:
                    ...
                    if (asset != null) {
                        ...
                        Log.d(TAG, "DOWNLOAD UPDATE NOTIFICATION FOR UNKNOWN" + " stat: " + (hasInfo ? info : "unknown"));
                    }
                    break;
