...
class VideoPlayerActivity : Activity(),  PlaybackPreparer {
    ...
    private fun buildDataSourceFactory(): DataSource.Factory =
        DefaultDataSourceFactory(applicationContext, DefaultHttpDataSourceFactory("download2go1.4"))
    ...
    companion object {
        ...
        private const val ACTION_VIEW = "com.penthera.download2go1.4.exoplayer.action.VIEW"
