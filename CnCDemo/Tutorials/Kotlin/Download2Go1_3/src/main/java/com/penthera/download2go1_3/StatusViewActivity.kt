...
class StatusViewActivity : AppCompatActivity() {
    ...
    private fun authenticationString(status: Int): String {
        ...
        when (status) {
            AuthenticationStatus.AUTHENTICATED -> statusString =
                "AUTHENTICATED"
            AuthenticationStatus.NOT_AUTHENTICATED -> statusString =
                "NOT_AUTHENTICATED"
            AuthenticationStatus.AUTHENTICATION_EXPIRED -> statusString =
                "AUTHENTICATION_EXPIRED"
            AuthenticationStatus.INVALID_LICENSE -> statusString =
                "INVALID_LICENSE"
            AuthenticationStatus.SHUTDOWN -> statusString =
                "LOGGED OUT"
        }
        return statusString
    }
