...
class VideoPlayerActivity : Activity(),  PlaybackPreparer {
    ...
    private fun buildDataSourceFactory(): DataSource.Factory =
        DefaultDataSourceFactory(applicationContext, DefaultHttpDataSourceFactory("download2go1.6"))
    ...
    companion object {
        ...
        private const val ACTION_VIEW = "com.penthera.download2go1.6.exoplayer.action.VIEW"
