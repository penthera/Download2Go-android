package com.penthera.sdkdemokotlin.provider
...
class DemoContentProvider : VirtuosoSDKContentProvider() {
     ...
     */
    init {
        setAuthority("com.penthera.virtuososdk.provider.sdkkotlindemo")
    }
    ...
    override fun getAuthority(): String {
        return "com.penthera.virtuososdk.provider.sdkkotlindemo"
    }
}