...
class TrackSelectionDialog : DialogFragment() {
            ...
            trackSelectionDialog.init( /* titleId= */
                    ...
                    DialogInterface.OnClickListener { _: DialogInterface?, _: Int ->
                        ...
                        for (i in 0 until mappedTrackInfo.rendererCount) {
                            ...
                            val overrides: List<SelectionOverride> = trackSelectionDialog.getOverrides( /* rendererIndex= */i)
    ...
    fun getIsDisabled(rendererIndex: Int): Boolean {
        val rendererView: TrackSelectionViewFragment? = tabFragments[rendererIndex]
    ...
    override fun onCreateView(
        ...
        viewPager.adapter = FragmentAdapter(childFragmentManager, tabFragments, tabTrackTypes, resources)
