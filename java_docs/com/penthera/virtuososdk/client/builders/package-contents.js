var classSelectorHTML = '\
	...
	<optgroup label="Classes">\
		...
		<option value="com.penthera.virtuososdk.client.builders/HLSAssetBuilder">HLSAssetBuilder</option>\
		<option value="com.penthera.virtuososdk.client.builders/HLSAssetBuilder.HLSAssetParams">HLSAssetBuilder.HLSAssetParams</option>\
		<option value="com.penthera.virtuososdk.client.builders/HSSAssetBuilder">HSSAssetBuilder</option>\
	...
	<optgroup label="Exceptions">\
		...
		<option value="com.penthera.virtuososdk.client.builders/HLSAssetBuilder.HLSAssetParamsException">HLSAssetBuilder.HLSAssetParamsException</option>\
		<option value="com.penthera.virtuososdk.client.builders/HSSAssetBuilder.HSSAssetParamsException">HSSAssetBuilder.HSSAssetParamsException</option>\
		<option value="com.penthera.virtuososdk.client.builders/MPDAssetBuilder.MPDAssetParamsException">MPDAssetBuilder.MPDAssetParamsException</option>\
	</optgroup>\
';
