...
import com.penthera.common.utility.CommonUtil.LoggerHelper
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        logLevelSpinner.onItemSelectedListener = object : OnItemSelectedListener {
            override fun onItemSelected(parent: AdapterView<*>?, view: View, position: Int, id: Long) {
                ...
                val enabled: Boolean = when (position) {
                    4 -> false
                    else -> true
                }

                // This method updates the logging level for the SDK
                LoggerHelper.updateLoggerPriority(sdkLogLevel, this@MainActivity)
                LoggerHelper.enableLogger(enabled, this@MainActivity)
            }
    ...
    private fun downloadAsset(){
        ...
        val params = MPDAssetBuilder().apply {
            ...
            desiredVideoBitrate(Long.MAX_VALUE)//specify a bitrate for desired video quality Integer.MAX_VALUE for largest available
