...
import com.penthera.download2go1_8.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun configureCodecFilters() {

        // Set audio codecs to download
        val audioCodecs = Array<String>(1) {"mp4a.40.2"}
        virtuoso.settings.audioCodecsToDownload = audioCodecs

        // Set video codecs to download
        val videoCodecs = Array<String>(1) {"avc1.42c01e"}
        virtuoso.settings.audioCodecsToDownload = videoCodecs
