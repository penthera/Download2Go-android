...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        logLevelSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                // This method updates the logging level for the SDK
                CommonUtil.LoggerHelper.updateLoggerPriority(sdkLogLevel, MainActivity.this);
                CommonUtil.LoggerHelper.enableLogger(enable, MainActivity.this);
            }
    ...
    public void initVirtuosoSDK() {
        ...
        CommonUtil.LoggerHelper.updateLoggerPriority(Log.DEBUG, this);
