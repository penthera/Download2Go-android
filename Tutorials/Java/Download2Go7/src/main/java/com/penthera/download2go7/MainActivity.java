...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String ASSET_ID = "SEASON-1-EPISODE-1";
    private static final String ASSET_ID2 = "SEASON-1-EPISODE-2";
    private static final String ASSET_ID3 = "SEASON-1-EPISODE-3";
    private static final String ASSET_ID4 = "SEASON-1-EPISODE-4";

    private static final String ASSET_TITLE = "Season 1 Episode 1";
    private static final String ASSET_TITLE2 = "Season 1 Episode 2";
    private static final String ASSET_TITLE3 = "Season 1 Episode 3";
    private static final String ASSET_TITLE4 = "Season 1 Episode 4";
    private static final String ASSET_URL = "http://virtuoso-demo-content.s3.amazonaws.com/bbb/season1/ep1/index.m3u8";
    private static final String ASSET_URL2 = "http://virtuoso-demo-content.s3.amazonaws.com/bbb/season1/ep2/index.m3u8";
    private static final String ASSET_URL3 = "http://virtuoso-demo-content.s3.amazonaws.com/bbb/season1/ep1/index.m3u8";
    private static final String ASSET_URL4 = "http://virtuoso-demo-content.s3.amazonaws.com/bbb/season1/ep1/index.m3u8";

    private static final String TEST_PLAYLIST_NAME = "TEST PLAYLIST";

    public static List<String> ASSET_LIST;
    public static Map<String, Pair<String,String>> ASSET_DETAIL_MAP;



    static{
        ASSET_LIST = Arrays.asList(ASSET_ID, ASSET_ID2,ASSET_ID3,ASSET_ID4);
        ASSET_DETAIL_MAP = new HashMap<>();
        ASSET_DETAIL_MAP.put(ASSET_ID, new Pair<>(ASSET_TITLE, ASSET_URL));
        ASSET_DETAIL_MAP.put(ASSET_ID2, new Pair<>(ASSET_TITLE2, ASSET_URL2));
        ASSET_DETAIL_MAP.put(ASSET_ID3, new Pair<>(ASSET_TITLE3, ASSET_URL3));
        ASSET_DETAIL_MAP.put(ASSET_ID4, new Pair<>(ASSET_TITLE4, ASSET_URL4));
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        playlistBtn = findViewById(R.id.show_playlist);
    ...
    private IAsset getCurrentAsset(){
        IAsset ret = null;

        for(String id : ASSET_LIST) {
            List<IIdentifier> list = virtuoso.getAssetManager().getByAssetId(id);
            if (list != null && list.size() > 0) {
                ret = (IAsset) list.get(0);
                break;
            }
        }
    ...
    private void updateUI() {
        ...
        playlistBtn.setEnabled(asset != null);
    ...
    private void downloadAsset() {
        ...
        IPlaylist playlist = virtuoso.getAssetManager().getPlaylistManager().find(TEST_PLAYLIST_NAME);
        ...
        if(playlist != null){
            ...
            virtuoso.getAssetManager().getPlaylistManager().clear(TEST_PLAYLIST_NAME);

            //then add the assets we want in the playlist
            playlist.append(ASSET_LIST);
        }
        else{
            //create playlist configuration options
            IPlaylistConfig playlistOptions = new PlaylistConfigBuilder()
            ...
            virtuoso.getAssetManager().getPlaylistManager().create(playlistOptions, ASSET_LIST);
        }
    ...
    private void showPlaylist(){
        ...
        intent.putExtra(PlaylistItemsActivity.PLAYLIST_NAME, TEST_PLAYLIST_NAME);
    ...
    static class AssetQueueObserver implements Observers.IQueueObserver {
        ...
        private void updateItem(final IIdentifier identifier, boolean forceUpdate) {
            if (identifier instanceof IAsset) {
                ...
                if (!TextUtils.isEmpty(assetId) && ASSET_LIST.contains(assetId)){
        ...
        private void updateItemStatus(final IAsset asset, boolean forceUpdate) {
            ...
            if (ASSET_LIST.contains(asset.getAssetId())) {
                mainActivity.asset = asset;
